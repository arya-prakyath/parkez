...
export default function SpotTermsAndConditions({
    ...
    return (
        <View style={styles.credentialParentContainer}>
            <Text allowFontScaling={false} style={styles.termsAndConditionsHeader}>Term & Conditions</Text>
            ...
            <View style={styles.nextBackButtonContainer}>
                ...
                <TouchableOpacity style={styles.nextButton} onPress={() => {
                    ...
                    <Text allowFontScaling={false} style={styles.nextButtonText}>Agree</Text>
                    <Image
